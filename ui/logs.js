...
export function renderPanelLogs(){
  renderGlobalInto(els.log,      ['skilling','woodcutting','crafting','cooking','economy']);
 ...
 *    pushLog('Crafted Handle → +6 craft xp','crafting');
 */
export const pushLog = (m, type='skilling') => { logEvent(type, m); renderPanelLogs(); };

/* (Optional) keep these if you still call them elsewhere */
